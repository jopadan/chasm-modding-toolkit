// Chasm Floor Tag Editor v1.0.2 (v106)
...
void renderOverlay(){
    ...
    drawText("F12: Save changes",xbase,ybase); ybase -= dy;
    ...
    if (dirty) {
        ...
        drawText("MODIFIED - PRESS F12 TO SAVE!",xbase,20);
        glEnable(GL_TEXTURE_2D);
    }
...
int main(int argc,char **argv){
    ...
    glutCreateWindow("Chasm The Rift Floor Flag Editor v1.0.2 by SMR9000");
