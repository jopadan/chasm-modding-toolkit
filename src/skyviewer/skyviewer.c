...
// field of view
static float fov = 80;
static const float FOV_MIN = 40, FOV_MAX = 120, FOV_DEFAULT = 80;
...
static Tile gridTiles[] = {
    ...
    {GL_TEXTURE_CUBE_MAP_POSITIVE_Y, 2,2,  -180,    0,    0},  // top
    {GL_TEXTURE_CUBE_MAP_NEGATIVE_Y, 2,0,   180,    0,    0},  // bottom
...
int main(int argc,char**argv){
    ...
    glutCreateWindow("Chasm The Rift Remastered Cubemap/Skybox Viewer v1.0.1. By SMR9000");
